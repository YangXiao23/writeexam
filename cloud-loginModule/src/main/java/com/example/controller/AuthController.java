...
public class AuthController {
    ...
    @PostMapping("/login")
    public CommonResponse login(@RequestParam(name = "username", required = true) String username, @RequestParam(name = "password", required = true) String password, HttpServletRequest request) {
